    ...
    <main>
        ...
        <section class="productos_seccion">
            ...
            data-precio="$3.19">
                ...
                <p>
                    Arroz de primera calidad, cultivado en Chiriquí con procesos
                    modernos de selección y empaque.
                </p>
            ...
            data-precio="$1.35">
                ...
                <p>
                    Un tesoro panameño, conocido por su sabor auténtico y textura suave,
                    perfecto para refritos o sopas.
                </p>
            ...
            data-precio="$1.55 ">
                ...
                <p>
                    La base de recetas ricas en fibra y tradición, versátil y nutritivo.
                </p>
                <p><strong>Precio:</strong> $1.55</p>
                <p>Precio/Unidad</p>
                <a  class="btn_producto">ver más</a>
            ...
            data-precio="$1.55 ">
                ...
                <p>
                    La joya de la dieta, listas para transformar tus potajes en comidas
                    rápidas, nutritivas y llenas de energía.
                </p>
                <p><strong>Precio:</strong> $1.55</p>
                <p>Precio/Unidad</p>
                <a class="btn_producto">ver más</a>
            ...
            data-precio="$1.69">
                ...
                <p>
                    Con un color intenso y sabor robusto, perfectos para acompañamientos
                    o platos principales.
                </p>
                <p><strong>Precio:</strong> $1.69</p>
                <p>Precio/Unidad</p>
                <a class="btn_producto">ver más</a>
            </article>
            <article class="producto"
            ...
            data-precio="$1.25">
                ...
                <p>
                    Alternativa versátil y nutritiva. Ideal para sustituir al arroz o la
                    quinoa, añadiendo fibra y proteína a tus ensaladas y guisos
                    saludables.
                </p>
                <p><strong>Precio:</strong> $1.25</p>
                <p>Precio/Unidad</p>
                <a class="btn_producto">ver más</a>
            </article>
            <article class="producto"
            ...
            data-precio="$0.85">
                ...
                <p>
                    Sabor tradicional e inconfundible. Perfecto para sopas, caldos
                    sustanciosos y la base de auténticas recetas panameñas.
                </p>
                <p><strong>Precio:</strong> $0.85</p>
                <p>Precio/Unidad</p>
